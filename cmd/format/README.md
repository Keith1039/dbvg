...
Please consult the [list of defined Strategies](../../strategy/Existing_Strategies.md) for more information regarding the accepted data type for the `value` field.
